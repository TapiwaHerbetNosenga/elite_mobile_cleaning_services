...
const WhatsappBooking = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-white rounded shadow-md"> {/* Form styling */}
      ...
      <button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"> {/* Submit button styling */}
        Submit
      </button>
    </form>
  );
